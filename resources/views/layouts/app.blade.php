...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <title>{{ __('Sisgestra') }}@yield('title')</title>

    <meta content='width=device-width, initial-scale=1.0, maximum-scale=1.0, user-scalable=0, shrink-to-fit=no' name='viewport' />
    <link rel="apple-touch-icon" sizes="76x76" href="{{ asset('images/logo.ico') }}">
    <link rel="icon" type="image/png" href="{{ asset('images/icon/logo.ico') }}">
    <!--     Fonts and icons     -->
    ...
    <body class="{{ $class ?? '' }}">
        ...
        {{-- mis scipts --}}
        <script src="//cdn.jsdelivr.net/npm/alertifyjs@1.13.1/build/alertify.min.js"></script>        <script src="{{ asset('js/scripts.js') }}"></script>
